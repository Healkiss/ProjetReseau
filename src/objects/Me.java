...
public class Me implements Serializable {
	...
	private static ArrayList<ContactServer> friends;
	...
	public Me(){	
		meId = 0;
		friends = new ArrayList<ContactServer>();
	}
	...
	public static void addFriend(ContactServer contact){
		friends.add(contact);
	}
	
	public static void removeFriend(ContactServer contact){
